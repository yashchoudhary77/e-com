...
![BuyIT](/frontend/public/images/BuyIT.jpg)
...
- 👉 Render : [https://BuyIT.onrender.com](https://BuyIT.onrender.com)
...
```
$ git clone git@github.com:basir/mern-BuyIT.git
$ cd mern-BuyIT
```
...
- Local MongoDB
  ...
  - In .env file update MONGODB_URI=mongodb://localhost/BuyIT
